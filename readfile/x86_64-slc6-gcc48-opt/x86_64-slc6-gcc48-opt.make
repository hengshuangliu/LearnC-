...
readfile_tag=$(tag)
READFILEROOT=/home/shuang/c++/c++/readfile
readfile_root=/home/shuang/c++/c++/readfile
READFILEVERSION=v0
readfile_cmtpath=/home/shuang/c++/c++
readfile_project=c++
tag=x86_64-slc6-gcc48-opt
package=readfile
version=v0
PACKAGE_ROOT=$(READFILEROOT)
srcdir=../src
bin=../$(readfile_tag)/
BIN=/home/shuang/c++/c++/readfile/$(readfile_tag)/
javabin=../classes/
mgrdir=cmt
project=c++
...
use_linkopts= $(cmt_installarea_linkopts)   $(readfile_linkopts) 
...
use_stamps=  $(readfile_stamps) 
use_cflags=  $(readfile_cflags) 
use_pp_cflags=  $(readfile_pp_cflags) 
use_cppflags=  $(readfile_cppflags) 
use_pp_cppflags=  $(readfile_pp_cppflags) 
use_fflags=  $(readfile_fflags) 
use_pp_fflags=  $(readfile_pp_fflags) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
use_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
use_use_linkopts=  $(readfile_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= use 
all_constituents= $(constituents)
constituentsclean= useclean 
